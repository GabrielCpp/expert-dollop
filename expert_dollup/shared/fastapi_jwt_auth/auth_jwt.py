...
from expert_dollup.shared.fastapi_jwt_auth.auth_config import AuthConfig
from expert_dollup.shared.fastapi_jwt_auth.exceptions import (
    InvalidHeaderError,
    CSRFError,
    JWTDecodeError,
    RevokedTokenError,
...
class AuthJWT(AuthConfig):
    ...
    def _verify_jwt_in_request(
        ...
        claims = self.get_raw_jwt(token)

        if "type" in claims and claims["type"] != type_token:
