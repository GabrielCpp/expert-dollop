...
from injector import Binder, singleton, Injector, Provider, inject
from expert_dollup.shared.automapping import Mapper, AggregateFactory
...
def bind_mapper(binder: Binder) -> None:
    ...
    binder.bind(AggregateFactory, to=inject(AggregateFactory), scope=singleton)
